        ...
        <div className="screen">
            <div className="leftColumnHome">
                <div className='homeImgDiv'>
                    <img className='rotateLeftLC' src={greySquare} alt='picture of me' />
                </div>
                <div className='homeImgDiv'>
                    <img className='rotateRightLC' src={greySquare} alt='picture of me' />
                </div>
            </div>
            ...
            <div className='homeImgDiv'>
                    <img className='rotateLeftRC' src={greySquare} alt='picture of me' />
                </div>
                <div className='homeImgDiv'>
                    <img className='rotateRightRC' src={greySquare} alt='picture of me' />
                </div>
            </div>
        </div>
    )
